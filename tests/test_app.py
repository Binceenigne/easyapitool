...
class StaticAssetCacheTests(unittest.TestCase):
    ...
    def test_main_page_has_lucide_icons_and_continuous_container_font_scaling(self):
        ...
        self.assertIn('<link rel="stylesheet" href="styles/app.css?v=42">', page)
        self.assertNotIn('id="keyTotal"', page)
        self.assertNotIn('id="keyUsed"', page)
        self.assertNotIn('id="keyTodayUsed"', page)
        ...
        self.assertIn("set_window_background(resolvedMode)", page)
        self.assertIn("systemThemeMedia.addEventListener('change', handleSystemThemeChange)", page)
